...
- `crlibreall/FE|NC|ND|gen_xml_nc` now runs as native Python compatibility handlers (legacy-equivalent minimal behavior).
- Fallback proxy remains enabled as deployment safety net, but no tracked route currently depends on it.
