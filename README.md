...
### Opciones para correr la API

- Corriendo el servidor apache de la forma normal y tradicional.
- Corriendo docker (asegúrate de leer el archivo `docker-compose.md` antes de levantarlo)
