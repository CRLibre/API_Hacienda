"""
AUTO-PORTED FROM: api/contrib/facturador/facturadorCRLibre.php
...
def getComapannyIdUser(sessionKey, idMasterUser):
    """
    AUTO-PORTED PHP BODY (verbatim)
    --------------------------------
...
def getProdCompannyCredentials():
    """
    AUTO-PORTED PHP BODY (verbatim)
    --------------------------------
...
def getCompannyInformationAdmin():
    """
    AUTO-PORTED PHP BODY (verbatim)
    --------------------------------
...
def getCompannyLocationInformation():
    """
    AUTO-PORTED PHP BODY (verbatim)
    --------------------------------
...
def getStagCompannyCredentials():
    """
    AUTO-PORTED PHP BODY (verbatim)
    --------------------------------
...
def copyInventaryTable(idSucursal, idUser):
    """
    AUTO-PORTED PHP BODY (verbatim)
    --------------------------------
...
def companny_add_master_Consecutive():
    """
    AUTO-PORTED PHP BODY (verbatim)
    --------------------------------
...
def insertToLogTable(idUser, json):
    """
    AUTO-PORTED PHP BODY (verbatim)
    --------------------------------
...
def companny_updateConsecutive():
    """
    AUTO-PORTED PHP BODY (verbatim)
    --------------------------------
...
def confirmSessionKey(idMasterUser):
    """
    AUTO-PORTED PHP BODY (verbatim)
    --------------------------------
