    ...
    $paths = array(
        ...
        array(
            ...
            'params' => array(
                ...
                array("key" => "emisor_email",                      "def" => "",        "req" => true),
                array("key" => "omitir_receptor",                   "def" => "false",   "req" => false),
                array("key" => "receptor_nombre",                   "def" => "0",        "req" => false),
                array("key" => "receptor_tipo_identif",             "def" => "0",        "req" => false),
                array("key" => "receptor_num_identif",              "def" => "0",        "req" => false),
                array("key" => "receptor_identif_extranjero",       "def" => "0",        "req" => false),
                array("key" => "receptor_nombre_comercial",         "def" => "0",        "req" => false),
                array("key" => "receptor_provincia",                "def" => "0",        "req" => false),
                array("key" => "receptor_canton",                   "def" => "0",        "req" => false),
                array("key" => "receptor_distrito",                 "def" => "0",        "req" => false),
                array("key" => "receptor_barrio",                   "def" => "0",        "req" => false),
                array("key" => "receptor_otras_senas",              "def" => "0",        "req" => false),
                array("key" => "receptor_otras_senas_extranjero",   "def" => "0",        "req" => false),
                array("key" => "receptor_cod_pais_tel",             "def" => "0",        "req" => false),
                array("key" => "receptor_tel",                      "def" => "0",        "req" => false),
                array("key" => "receptor_cod_pais_fax",             "def" => "0",        "req" => false),
                array("key" => "receptor_fax",                      "def" => "0",        "req" => false),
                array("key" => "receptor_email",                    "def" => "0",        "req" => false),
                array("key" => "condicion_venta",                   "def" => "",        "req" => true),
                array("key" => "plazo_credito",                     "def" => "0",       "req" => false),
                array("key" => "medio_pago",                        "def" => "",        "req" => false),
                array("key" => "medios_pago",                       "def" => "",        "req" => true),
