    ...
    $paths = array(
        array(
            ...
            'params'        => array(
                    ...
                    array("key" => "codigo_actividad",              "def" => "", "req" => false),
                    array("key" => "condicion_impuesto",            "def" => "", "req" => false),
                    array("key" => "monto_total_impuesto_acreditar", "def" => "", "req" => false),
                    array("key" => "monto_total_de_gasto_aplicable", "def" => "", "req" => false),
        ...
        array(
            ...
            'params' => array(
                ...
                array("key" => "total_merc_exoneradas", "def" => "",        "req" => false),
                ...
                array("key" => "total_iva_devuelto",    "def" => "",        "req" => false),
                array("key" => "total_otros_cargos",    "def" => "",        "req" => false),
                ...
                array("key" => "otros_cargos",          "def" => "",        "req" => false)
            ),
            'file'          => 'genXML.php'
        ),
        array(
