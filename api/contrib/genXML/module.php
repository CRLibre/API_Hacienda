    ...
    $paths = array(
        ...
        array(
            ...
            'params' => array(
                ...
                array("key" => "total_serv_exonerados",             "def" => "",        "req" => true),
                array("key" => "total_merc_gravada",                "def" => "",        "req" => true),
                array("key" => "total_merc_exenta",                 "def" => "",        "req" => true),
                array("key" => "total_merc_exonerada",              "def" => "",        "req" => true),
                array("key" => "total_gravados",                    "def" => "",        "req" => true),
                array("key" => "total_exento",                      "def" => "",        "req" => true),
                array("key" => "total_exonerado",                   "def" => "",        "req" => true),
